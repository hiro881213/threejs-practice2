...
export const makeBasicTexture = () => {
    ...
    // ポリゴンを生成する
    let polyhedron = createMesh(new THREE.IcosahedronGeometry(5, 0), "metal-rast.jpg")
    ...
    // 立方体を生成する
    let cube = createMesh(new THREE.BoxGeometry(5, 5, 5, "brick-wall.jpg"));
    ...
    document.getElementById("basicTexture-output").appendChild(webGLRenderer.domElement);
